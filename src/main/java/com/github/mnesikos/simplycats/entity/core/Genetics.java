...
public class Genetics {
    ...
    public enum Phaeomelanin {
        ...
        public static String getPhenotype(String phaeomelanin) {
            if (phaeomelanin.equals("XO-Y") || phaeomelanin.equals("Y-XO") || phaeomelanin.equals("XO-XO"))
                return RED.toString().toLowerCase();
            else if (phaeomelanin.equals("Xo-Y") || phaeomelanin.equals("Y-Xo") || phaeomelanin.equals("Xo-Xo"))
                return NOT_RED.toString().toLowerCase();
            else if (phaeomelanin.equals("XO-Xo") || phaeomelanin.equals("Xo-XO"))
                return TORTOISESHELL.toString().toLowerCase();
            else
                throw new IllegalArgumentException("Invalid phaeomelanin: " + phaeomelanin + ", this error should not happen please report it to Simply Cats' issue tracker.");
        }
    }
    ...
    public enum Spotted {
        ...
        public static String getPhenotype(String spotted) {
            if (spotted.equals("Sp-Sp"))
                return SPOTTED.toString().toLowerCase();
            else if (spotted.equals("Sp-sp") || spotted.equals("sp-Sp"))
                return BROKEN.toString().toLowerCase();
            else if (spotted.equals("sp-sp"))
                return NORMAL.toString().toLowerCase();
            else
    ...
    public enum Colorpoint {
        ...
        public static String getPhenotype(String colorpoint) {
            if (colorpoint.equals("C-C") || colorpoint.equals("C-cs") || colorpoint.equals("C-cb") ||
                    colorpoint.equals("cs-C") || colorpoint.equals("cb-C"))
                return NOT_POINTED.toString().toLowerCase();
            else if (colorpoint.equals("cs-cs"))
                return COLORPOINT.toString().toLowerCase();
            else if (colorpoint.equals("cs-cb") || colorpoint.equals("cb-cs"))
                return MINK.toString().toLowerCase();
            else if (colorpoint.equals("cb-cb"))
    ...
    public enum White {
        ...
        public static String getPhenotype(String white) {
            if (white.equals("Wd-Wd") || white.equals("Wd-w") || white.equals("Wd-Ws") ||
                    white.equals("w-Wd") || white.equals("Ws-Wd"))
                return DOMINANT.toString().toLowerCase();
            else if (white.equals("Ws-Ws") || white.equals("Ws-w") || white.equals("w-Ws"))
                return SPOTTING.toString().toLowerCase();
            else if (white.equals("w-w"))
