...
public class SCItems {
    ...
    public static final RegistryObject<Item> CATNIP = REGISTRAR.register("catnip", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> CATNIP_SEEDS = REGISTRAR.register("catnip_seeds", () -> new ItemNameBlockItem(SCBlocks.CATNIP_CROP.get(), new Item.Properties()));
