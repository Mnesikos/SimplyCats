	...
	public void manipulateTradesForVillager(EntityVillager villager, MerchantRecipeList recipeList, Random random) {
		...
		if (villager.getProfession() == 28643) {
			if (SimplyCatsConfig.ADOPT_A_DOG)
		    	recipeList.addToListWithCheck(new MerchantRecipe(new ItemStack(Items.bone, price), dog));
		    recipeList.addToListWithCheck(new MerchantRecipe(new ItemStack(Items.fish, price), cat));
		}
	}
}