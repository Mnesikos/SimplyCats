...
public class CatBlocks {
    ...
    public static final Map<EnumDyeColor, BlockCatTree> CAT_TREE_BEDS = new HashMap<>();
    public static final Map<EnumDyeColor, BlockCatTree> CAT_TREE_POSTS = new HashMap<>();
    public static final Map<EnumDyeColor, BlockCatTree> CAT_TREE_BOXES = new HashMap<>();
    ...
    static {
        for (EnumDyeColor color : EnumDyeColor.values()) {
            ...
            CAT_TREE_BEDS.put(color, registerBlock("cat_tree_bed_" + color.getName(), new BlockCatTree(color)));
            CAT_TREE_POSTS.put(color, registerBlock("cat_tree_post_" + color.getName(), new BlockCatTree(color)));
            CAT_TREE_BOXES.put(color, registerBlock("cat_tree_box_" + color.getName(), new BlockCatTree(color)));
        }
