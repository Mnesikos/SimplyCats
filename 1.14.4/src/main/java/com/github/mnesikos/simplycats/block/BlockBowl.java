...
public class BlockBowl extends BlockTileEntity<TileEntityBowl> {
    ...
    @Nullable
    @Override
    public TileEntityBowl createTileEntity(BlockState state, IBlockReader world) {
